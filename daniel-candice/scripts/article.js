...
Article.prototype.toHtml = function() {
  ...
  let compiledTemplate = Handlebars.compile($('#blog-template').html());
...
// "(a,b)" refers to parameters that are being passed into the .sort function. "articleObject" and "article" are references to the actual objects that are being executed upon
rawData.sort((a,b) => {
